...
- [3、进程调度算法的特点和引用场景](#3进程调度算法的特点和引用场景)
...
- [8、Synchronized的用法](#8synchronized的用法)
...
- [11、分页管理和分段管理](#11分页管理和分段管理)
    - [11.1 概念](#111-概念)
    - [11.2 区别](#112-区别)
- [12、动态链接和静态链接](#12动态链接和静态链接)
    - [12.1 静态链接](#121-静态链接)
    - [12.2 动态链接](#122-动态链接)
